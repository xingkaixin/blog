...
title: 策略组的需求和设计思路分享
date: 2019-06-30
summary: 本文旨在分享关于策略组的需求和设计思路，以适用于不同的科学上网应用，如 Surge、Clash、Quantumult、Quantumult X。首先，我们需要将线路类型分为直连、公网中转、内网中转，再将节点根据地区分组，如香港、日本、新加坡、美国等。最后，我们可以根据具体应用要求来进行选择节点类型。并且，建议每个服务都保留一个直连节点，以便在不同地区时进行适当的调整，从而获得更好的使用体验。
tags:
  - 策略组
  - 科学上网
