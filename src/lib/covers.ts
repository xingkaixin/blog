...
export const covers = {
  ...
  "315-geo-ai-poisoning.png": {
    full: c315GeoAiPoisoningFull,
    desktop: c315GeoAiPoisoning800,
    mobile: c315GeoAiPoisoning400,
  },
  ...
  "agent-friendly-tool.png": {
    full: cAgentFriendlyToolFull,
    desktop: cAgentFriendlyTool800,
    mobile: cAgentFriendlyTool400,
  },
  "agent-guesses-not-debug.png": {
    full: cAgentGuessesNotDebugFull,
    desktop: cAgentGuessesNotDebug800,
    mobile: cAgentGuessesNotDebug400,
  },
  "agentic-workflow-waiting-revalued.png": {
    full: cAgenticWorkflowWaitingRevaluedFull,
    desktop: cAgenticWorkflowWaitingRevalued800,
    mobile: cAgenticWorkflowWaitingRevalued400,
  },
  "ai-code-5-checkpoints.png": {
    full: cAiCode5CheckpointsFull,
    desktop: cAiCode5Checkpoints800,
    mobile: cAiCode5Checkpoints400,
  },
  "ai-code-responsibility-gap.png": {
    full: cAiCodeResponsibilityGapFull,
    desktop: cAiCodeResponsibilityGap800,
    mobile: cAiCodeResponsibilityGap400,
  },
  "ai-code-review-expensive-testing.png": {
    full: cAiCodeReviewExpensiveTestingFull,
    desktop: cAiCodeReviewExpensiveTesting800,
    mobile: cAiCodeReviewExpensiveTesting400,
  },
  "ai-code-volume-not-outcome.png": {
    full: cAiCodeVolumeNotOutcomeFull,
    desktop: cAiCodeVolumeNotOutcome800,
    mobile: cAiCodeVolumeNotOutcome400,
  },
  "ai-frontend-design-system-handoff.png": {
    full: cAiFrontendDesignSystemHandoffFull,
    desktop: cAiFrontendDesignSystemHandoff800,
    mobile: cAiFrontendDesignSystemHandoff400,
  },
  ...
  "ai-slop-battle.png": {
    full: cAiSlopBattleFull,
    desktop: cAiSlopBattle800,
    mobile: cAiSlopBattle400,
  },
  "ai-tests-closed-loop.png": {
    full: cAiTestsClosedLoopFull,
    desktop: cAiTestsClosedLoop800,
    mobile: cAiTestsClosedLoop400,
  },
  "ai-travel-talk-vs-act.png": {
    full: cAiTravelTalkVsActFull,
    desktop: cAiTravelTalkVsAct800,
    mobile: cAiTravelTalkVsAct400,
  },
  "ai-wont-tire-but-you-will.png": {
    full: cAiWontTireButYouWillFull,
    desktop: cAiWontTireButYouWill800,
    mobile: cAiWontTireButYouWill400,
  },
  "assuming-x-agentic-era-engineers-survival-coordinates.png": {
    full: cAssumingXAgenticEraEngineersSurvivalCoordinatesFull,
    desktop: cAssumingXAgenticEraEngineersSurvivalCoordinates800,
    mobile: cAssumingXAgenticEraEngineersSurvivalCoordinates400,
  },
  "best-ai-users-need-it-least.png": {
    full: cBestAiUsersNeedItLeastFull,
    desktop: cBestAiUsersNeedItLeast800,
    mobile: cBestAiUsersNeedItLeast400,
  },
  "beyond-the-3-day-clone.png": {
    full: cBeyondThe3DayCloneFull,
    desktop: cBeyondThe3DayClone800,
    mobile: cBeyondThe3DayClone400,
  },
  "codesesh-ai-coding-sessions-disappearing.webp": {
    full: cCodeseshAiCodingSessionsDisappearingFull,
    desktop: cCodeseshAiCodingSessionsDisappearing800,
    mobile: cCodeseshAiCodingSessionsDisappearing400,
  },
  "coding-agent-almost-1-year.png": {
    full: cCodingAgentAlmost1YearFull,
    desktop: cCodingAgentAlmost1Year800,
    mobile: cCodingAgentAlmost1Year400,
  },
  "enjoying-ai-too-much-scares-me.png": {
    full: cEnjoyingAiTooMuchScaresMeFull,
    desktop: cEnjoyingAiTooMuchScaresMe800,
    mobile: cEnjoyingAiTooMuchScaresMe400,
  },
  "from-writing-code-to-reviewing-code.png": {
    full: cFromWritingCodeToReviewingCodeFull,
    desktop: cFromWritingCodeToReviewingCode800,
    mobile: cFromWritingCodeToReviewingCode400,
  },
  "karpathy-join-anthropic.png": {
    full: cKarpathyJoinAnthropicFull,
    desktop: cKarpathyJoinAnthropic800,
    mobile: cKarpathyJoinAnthropic400,
  },
  "kv-cache-why-ai-replies-get-faster.png": {
    full: cKvCacheWhyAiRepliesGetFasterFull,
    desktop: cKvCacheWhyAiRepliesGetFaster800,
    mobile: cKvCacheWhyAiRepliesGetFaster400,
  },
  "llm-only-getting-average.png": {
    full: cLlmOnlyGettingAverageFull,
    desktop: cLlmOnlyGettingAverage800,
    mobile: cLlmOnlyGettingAverage400,
  },
  ...
  "mcp-cli-skill-evolution.png": {
    full: cMcpCliSkillEvolutionFull,
    desktop: cMcpCliSkillEvolution800,
    mobile: cMcpCliSkillEvolution400,
  },
  "mcp-vs-a2a-protocol-comparison.png": {
    full: cMcpVsA2aProtocolComparisonFull,
    desktop: cMcpVsA2aProtocolComparison800,
    mobile: cMcpVsA2aProtocolComparison400,
  },
  "model-core-tools-shell.png": {
    full: cModelCoreToolsShellFull,
    desktop: cModelCoreToolsShell800,
    mobile: cModelCoreToolsShell400,
  },
  "musk-vs-altman.png": {
    full: cMuskVsAltmanFull,
    desktop: cMuskVsAltman800,
    mobile: cMuskVsAltman400,
  },
  "persona-distillation.png": {
    full: cPersonaDistillationFull,
    desktop: cPersonaDistillation800,
    mobile: cPersonaDistillation400,
  },
  "rhythm-in-ai-coding.png": {
    full: cRhythmInAiCodingFull,
    desktop: cRhythmInAiCoding800,
    mobile: cRhythmInAiCoding400,
  },
  "session-as-asset.png": {
    full: cSessionAsAssetFull,
    desktop: cSessionAsAsset800,
    mobile: cSessionAsAsset400,
  },
  "skill-is-a-folder.png": {
    full: cSkillIsAFolderFull,
    desktop: cSkillIsAFolder800,
    mobile: cSkillIsAFolder400,
  },
  "spec-as-new-fig-leaf.png": {
    full: cSpecAsNewFigLeafFull,
    desktop: cSpecAsNewFigLeaf800,
    mobile: cSpecAsNewFigLeaf400,
  },
  "spec-tell-ai-what-not-to-do.png": {
    full: cSpecTellAiWhatNotToDoFull,
    desktop: cSpecTellAiWhatNotToDo800,
    mobile: cSpecTellAiWhatNotToDo400,
  },
  "spec-unwritten-assumptions.png": {
    full: cSpecUnwrittenAssumptionsFull,
    desktop: cSpecUnwrittenAssumptions800,
    mobile: cSpecUnwrittenAssumptions400,
  },
  "state-of-ai.webp": { full: cStateOfAiFull, desktop: cStateOfAi800, mobile: cStateOfAi400 },
  "stay-in-the-loop.png": {
    full: cStayInTheLoopFull,
    desktop: cStayInTheLoop800,
    mobile: cStayInTheLoop400,
  },
  "taste-is-a-muscle-predict-before-output.png": {
    full: cTasteIsAMusclePredictBeforeOutputFull,
    desktop: cTasteIsAMusclePredictBeforeOutput800,
    mobile: cTasteIsAMusclePredictBeforeOutput400,
  },
  ...
  "vibe-coding-ai-code-backlash-openclaw.png": {
    full: cVibeCodingAiCodeBacklashOpenclawFull,
    desktop: cVibeCodingAiCodeBacklashOpenclaw800,
    mobile: cVibeCodingAiCodeBacklashOpenclaw400,
  },
  "vibe-coding-to-agentic-engineering.png": {
    full: cVibeCodingToAgenticEngineeringFull,
    desktop: cVibeCodingToAgenticEngineering800,
    mobile: cVibeCodingToAgenticEngineering400,
  },
  "when-ai-bypasses-all-pitfalls.png": {
    full: cWhenAiBypassesAllPitfallsFull,
    desktop: cWhenAiBypassesAllPitfalls800,
    mobile: cWhenAiBypassesAllPitfalls400,
  },
  "why-i-pay.webp": { full: cWhyIPayFull, desktop: cWhyIPay800, mobile: cWhyIPay400 },
  "yomitomo-ai-reading-companion.webp": {
    full: cYomitomoAiReadingCompanionFull,
    desktop: cYomitomoAiReadingCompanion800,
    mobile: cYomitomoAiReadingCompanion400,
  },
} as const;
